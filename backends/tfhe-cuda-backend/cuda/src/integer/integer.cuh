...
__host__ void integer_radix_apply_univariate_lookup_table_kb(
  ...
  /// original indexing
  if (gpu_count > 1) {
    multi_gpu_lwe_init<Torus>(streams, gpu_indexes, gpu_count, lwe_array_in_vec,
                              lwe_indexes_in_vec, num_radix_blocks,
                              big_lwe_dimension + 1);
    multi_gpu_lwe_init<Torus>(streams, gpu_indexes, gpu_count, lwe_after_ks_vec,
    ...
    multi_gpu_lwe_scatter<Torus>(streams, gpu_indexes, gpu_count,
                                 ...
                                 lwe_indexes_in_vec, lut->lwe_indexes_in,
  ...
  if (gpu_count > 1) {
    multi_gpu_lwe_gather<Torus>(streams, gpu_indexes, gpu_count,
                                ...
                                small_lwe_dimension + 1);
    multi_gpu_lwe_release<Torus>(streams, gpu_indexes, lwe_array_in_vec);
    multi_gpu_lwe_release<Torus>(streams, gpu_indexes, lwe_after_ks_vec);
    multi_gpu_lwe_release<Torus>(streams, gpu_indexes, lwe_indexes_in_vec);
    multi_gpu_lwe_release<Torus>(streams, gpu_indexes, lwe_trivial_indexes_vec);
  }
...
__host__ void integer_radix_apply_bivariate_lookup_table_kb(
  ...
  if (gpu_count > 1) {
    ...
    multi_gpu_lwe_init<Torus>(streams, gpu_indexes, gpu_count, lwe_after_ks_vec,
                              ...
                              small_lwe_dimension + 1);
    multi_gpu_lwe_scatter<Torus>(streams, gpu_indexes, gpu_count,
                                 lwe_array_in_vec, lwe_array_pbs_in,
                                 lwe_indexes_in_vec, lut->lwe_indexes_in,
                                 num_radix_blocks, big_lwe_dimension + 1);
  } else {
    /// GPU 0 retains the original array
