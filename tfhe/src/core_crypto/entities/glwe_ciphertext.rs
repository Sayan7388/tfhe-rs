...
#[derive(Copy, Clone)]
pub struct GlweCiphertextParameters<T: UnsignedInteger> {
...
where
    C::Element: UnsignedInteger,
{
    type ParameterSet = GlweCiphertextParameters<C::Element>;

    fn is_conformant(&self, glwe_ct_parameters: &GlweCiphertextParameters<C::Element>) -> bool {
